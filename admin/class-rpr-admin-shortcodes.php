...
class RPR_Admin_Shortcodes {
	 ...
	 *
	 * @param string $editor_id The ID on the the post editor area.
	 *
	 * @return void
	 */
	...
	public function load_in_admin_footer_scr() {
		...
		include __DIR__ . '/views/rpr-modal-recipe.php';
	}
	 ...
	 *
	 * @global string $post_type
	 * @param array $hook Array of the current admin screen params.
	 *
	 * @return void
	 */

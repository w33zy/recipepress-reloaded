...
<div class="nutritionsbox">
	<div class="recipe_details_row">
		...
		<input type="number" min="0" name="rpr_recipe_calorific_value" id="rpr_recipe_calorific_value"
			   value="<?php echo $calorific_value; ?>"/>
		<span class="recipe-general-form-notes">kcal</span>
		<input type="number" min="0" name="rpr_recipe_calorific_value_kj" id="rpr_recipe_calorific_value_kj"
			   value="<?php echo round( 4.18 * (int) $calorific_value ); ?>"/>
	...
	<div class="recipe_details_row rpr_nutrition_row rpr_carbohydrate">
		...
		<input type="number" min="0" name="rpr_recipe_carbohydrate" id="rpr_recipe_carbohydrate"
			   value="<?php echo $carbohydrate; ?>"/>
		<span class="recipe-general-form-notes">g</span>
	</div>
	...
	<div class="recipe_details_row rpr_nutrition_row rpr_nutrition_per">
		...
		<select name="rpr_recipe_nutrition_per" id="rpr_recipe_nutrition_per">
			<option value="per_100g" <?php if ( $per == 'per_100g' ) {
				echo 'selected';
			} ?>><?php _e( '100g', 'recipepress-reloaded' ); ?></option>
			<option value="per_portion" <?php if ( $per == 'per_portion' ) {
				echo 'selected';
			} ?>><?php _e( 'portion', 'recipepress-reloaded' ); ?></option>
			<option value="per_recipe" <?php if ( $per == 'per_recipe' ) {
				echo 'selected';
			} ?>><?php _e( 'recipe', 'recipepress-reloaded' ); ?></option>
		</select>

	...
	<form id="rpr-modal-form-scl" tabindex="-1">
		...
		<div id="rpr-modal-panel-scl">
			<ul id="rpr-modal-scl-mode">
				...
				<li>
					<input type="radio" value="rpr-recipe-grid" name="rpr-modal-scl-mode" id="rpr-modal-scl-mode-grid"/>
					<label for="rpr-modal-scl-mode-grid"><b><?php _e( 'Embed recipe index grid', 'recipepress-reloaded' ); ?></b></label>
				</li>
			</ul>
		</div>
		<div class="submitbox">
			...
			<div id="rpr-modal-update-scl">
				<input type="submit" value="<?php esc_attr_e( 'Include Shortcut', 'recipepress-reloaded' ); ?>"
					   class="button button-primary" id="rpr-modal-submit-scl" name="rpr-modal-submit-scl">
			</div>
		</div>
	</form>
</div>
